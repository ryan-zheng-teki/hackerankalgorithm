...
public class Solution {
    ...
    private static void generateAnswer(List<CrosswordPlaceHolder> leftRowwordsPlaceHolders,List<CrosswordPlaceHolder> leftColumnwordsPlaceHolders,
        ...
        if (leftRowwordsPlaceHolders.size() == 0) {
